...
object Books {
    ...
    val GAME_OF_THRONES_I = Book(
            isbn = Isbn13("9780553573404"),
            title = Title("A Game of Thrones: A Song of Ice and Fire (1)"),
            authors = listOf(GEORGE_RR_MARTIN)
    )
    val GAME_OF_THRONES_II = Book(
            isbn = Isbn13("9780553579901"),
            title = Title("A Clash of Kings: A Song of Ice and Fire (2)"),
            authors = listOf(GEORGE_RR_MARTIN)
    )
    val GAME_OF_THRONES_III = Book(
            isbn = Isbn13("9780553573428"),
            title = Title("A Storm of Swords: A Song of Ice and Fire (3)"),
            authors = listOf(GEORGE_RR_MARTIN)
    )
